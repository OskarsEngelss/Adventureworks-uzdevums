...
PRIMARY KEY(CustomerKey, ValidFromDate)
...
PRIMARY KEY(StoreKey, ValidFromDate)
PARTITION BY RANGE(ValidFromDate) (
    PARTITION p2025 VALUES LESS THAN ('2026-01-01'),
    PARTITION p202601 VALUES LESS THAN ('2026-02-01'),
    PARTITION p202602 VALUES LESS THAN ('2026-03-01'),
...
DISTRIBUTED BY HASH(PromotionKey) BUCKETS 5
PROPERTIES("replication_num" = "1");
...
PRIMARY KEY(VendorKey, ValidFromDate)
PARTITION BY RANGE(ValidFromDate) (
    PARTITION p2025 VALUES LESS THAN ('2026-01-01'),
    PARTITION p202601 VALUES LESS THAN ('2026-02-01'),
    PARTITION p202602 VALUES LESS THAN ('2026-03-01'),
...
PRIMARY KEY(WarehouseKey, ValidFromDate)
PARTITION BY RANGE(ValidFromDate) (
    PARTITION p2025 VALUES LESS THAN ('2026-01-01'),
    PARTITION p202601 VALUES LESS THAN ('2026-02-01'),
    PARTITION p202602 VALUES LESS THAN ('2026-03-01'),
